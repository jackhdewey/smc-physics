...
def init_scene():
    ...
    p.changeDynamics(plane, -1, mass=0.0, restitution=0.9)
    ...
    p.changeDynamics(plane2, -1, mass=0.0, restitution=0.9)
    ...
    p.changeDynamics(plane3, -1, mass=0.0, restitution=0.9)
    ...
    p.changeDynamics(plane4, -1, mass=0.0, restitution=0.9)
